  ...
  return (
    <div className={cn(
      ...
      <div className="md:hidden flex justify-between items-center px-4 py-3 border-b border-border bg-card/50 backdrop-blur-sm z-30">
        <h1 className="text-xl font-display font-bold text-primary">{USER_INFO.name}</h1>
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-auto relative z-10 px-6 py-8 md:px-8" onScroll={() => playSound('scroll')}>
